...
class StartingWidgetThree extends StatelessWidget {
  const StartingWidgetThree({super.key});
    ...
    return Scaffold(
        ...
        body: SafeArea(
          ...
          const Padding(
            ...
            child: Text(
              "Мы доставляем по всему Туркменистану, чтобы каждый мог насладиться превосходством наших текстильных материалов.",
              textAlign: TextAlign.center,
                ...
                child: TextButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const StartingWidgetFour(),
                      ),
                    );
                  },
